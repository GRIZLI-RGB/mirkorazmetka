...
export const ContactStructuredData = ({ 
  ...
  const webPageSchema = {
    ...
    description: getAllSettings?.settings.contacts_page_description || "Контактная информация финансового маркетплейса MFoxa",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: `https://mfoxa.com.ua${lang === 'ru' ? '/ru' : ''}/contacts`
      }
    ]
  };
  ...
  const organizationSchema = {
    ...
    name: "MFoxa",
    url: "https://mfoxa.com.ua",
    description: "Финансовый маркетплейс микрофинансовых организаций Украины",
