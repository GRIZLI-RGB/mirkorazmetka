...
export const AboutStructuredData = ({ 
  ...
  const webPageSchema = {
    ...
    "@type": "WebPage",
    name: getAllSettings?.settings.about_page_title || "Наша команда экспертов",
    description: getAllSettings?.settings.about_page_description || "Команда профессионалов финансовой сферы",
